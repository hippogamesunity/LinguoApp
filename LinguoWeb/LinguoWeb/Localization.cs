		...
		{
			{
				"PL", new Dictionary<string, string>
				{
					...
					{ "Contact.Text", "Георгий Милованов - глóвны володар\n<strong>Вспарте:</strong> <a href=\"Svaznoyjedi@mail.ru\">Svaznoyjedi@mail.ru</a>" }
				}
			},
			{
				"CZ", new Dictionary<string, string>
				{
					...
					{ "Contact.Text", "Георгий Милованов - главни́ володар\n<strong>Подпора:</strong> <a href=\"Svaznoyjedi@mail.ru\">Svaznoyjedi@mail.ru</a>" }
				}
			}
		};
