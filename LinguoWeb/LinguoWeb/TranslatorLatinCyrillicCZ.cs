...
namespace LinguoWeb
{
	public class TranslatorLatinCyrillicCZ : TranslatorBase
	{
		private const string LatinConsonants = "AaÁáEeÉéĚěOoÓóUuÚúŮůYyÝýIiÍí";
		private const string LatinVowels = "BbCcČčChchDdĎďFfGgHhKkLlMmNnŇňPpŘřSsŠšTtŤťVvZzŽž";
		...
		private static readonly Dictionary<string, string> SimpleReplace = new Dictionary<string, string>
		{
            ...
            { "Ó", "Ó" }, { "ó", "ó" },
            { "P", "П" }, { "p", "п" },
            { "Q", "Кв" + InvisibleChars.A }, { "q", "кв" + InvisibleChars.A },
            { "R", "Р" }, { "r", "р" },
            { "Ř", "Рь" }, { "ř", "рь" },
            { "S", "С" }, { "s", "с" },
            { "Š", "Ш" }, { "š", "ш" },
            ...
            { "Ů", "Ŏ" }, { "ů", "ŏ" },
            { "V", "В" }, { "v", "в" },
            { "W", "В" + InvisibleChars.A }, { "w", "в" + InvisibleChars.A },
            { "X", "Кс" + InvisibleChars.A }, { "x", "кс" + InvisibleChars.A },
            { "Z", "З" }, { "z", "з" },
            { "Ž", "Ж" }, { "ž", "ж" },
            { "Y", "Ы" }, { "y", "ы" },
            { "Ý", "Ы́" }, { "ý", "ы́" },                        
